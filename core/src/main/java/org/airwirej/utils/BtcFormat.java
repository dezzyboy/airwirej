...
import org.airwirej.utils.BtcAutoFormat.Style;
import static org.airwirej.utils.BtcAutoFormat.Style.*;
 ...
 * method.  This argument can be either a {@link org.airwirej.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    /**
      ...
      * {@link org.airwirej.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
