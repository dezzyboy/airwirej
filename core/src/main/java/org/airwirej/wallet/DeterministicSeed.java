...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link org.airwirej.crypto.MnemonicCode} for more
     ...
     *
     * @throws org.airwirej.crypto.MnemonicException if check fails
     */
