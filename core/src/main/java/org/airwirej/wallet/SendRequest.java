...
import org.airwirej.wallet.KeyChain.KeyPurpose;
import org.airwirej.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.airwirej.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.airwirej.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
