...
/**
 * <p>A KeyChainGroup is used by the {@link org.airwirej.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.airwirej.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.airwirej.crypto.KeyCrypterScrypt}.
     *
     * @throws org.airwirej.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
