...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.airwirej.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.airwirej.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.airwirej.crypto.KeyCrypter,
