 ...
 * {@link org.airwirej.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.airwirej.crypto.MnemonicCode},
 ...
 * {@link org.airwirej.crypto.DeterministicKey#serializePubB58(org.airwirej.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.airwirej.crypto.DeterministicKey#deserializeB58(org.airwirej.crypto.DeterministicKey, String, org.airwirej.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.airwirej.crypto.DeterministicKey,KeyChainType keyChaintype)}.</p>
 *
 * <p>This class builds on {@link org.airwirej.crypto.DeterministicHierarchy} and
 * {@link org.airwirej.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from airwirej users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.airwirej.crypto.DeterministicKey)}
     ...
     * @see org.airwirej.wallet.MarriedKeyChain
     */
