...
import org.airwirej.core.Message;
...
import org.airwirej.signers.*;
import org.airwirej.utils.*;
import org.airwirej.wallet.Protos.Wallet.*;
...
import org.airwirej.wallet.listeners.WalletEventListener;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.airwirej.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.airwirej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.airwirej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.airwirej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.airwirej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.airwirej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.airwirej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.airwirej.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.airwirej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.airwirej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.airwirej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.airwirej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.airwirej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.airwirej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of airwirej. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.airwirej.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.airwirej.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.airwirej.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.airwirej.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.airwirej.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.airwirej.crypto.KeyCrypter,
     ...
     * {@link org.airwirej.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.airwirej.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.airwirej.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.airwirej.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.airwirej.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.airwirej.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
