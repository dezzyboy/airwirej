...
import org.airwirej.core.PeerFilterProvider;
...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.airwirej.core.PeerFilterProvider}s, a merged
 * {@link org.airwirej.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.airwirej.core.PeerGroup} class internally.</p>
 *
