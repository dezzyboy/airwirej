...
import org.airwirej.net.discovery.HttpDiscovery;
...
import org.airwirej.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.airwirej.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.airwirej.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.airwirej.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.airwirej.core.AlertMessage}s. You can use {@link org.airwirej.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
