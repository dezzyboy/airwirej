 ...
 * the lightweight SPV mode, a {@link org.airwirej.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.airwirej.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
