...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of airwirej fixes the known
     ...
     * {@link org.airwirej.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.airwirej.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.airwirej.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.airwirej.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.airwirej.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.airwirej.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.airwirej.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.airwirej.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.airwirej.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a airwirej based app running in SPV mode to fully validating security.
     */
