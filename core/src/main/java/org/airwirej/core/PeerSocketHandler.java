...
import org.airwirej.net.AbstractTimeoutHandler;
import org.airwirej.net.MessageWriteTarget;
 ...
 * {@link org.airwirej.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.airwirej.net.NioClient} or
     * {@link org.airwirej.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
