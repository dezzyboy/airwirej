...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.airwirej.store.SPVBlockStore} or you could also try a
     * {@link org.airwirej.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
