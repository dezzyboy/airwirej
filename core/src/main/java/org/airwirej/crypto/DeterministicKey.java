...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link org.airwirej.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
     ...
     * in which case the time is stored alongside the key as per normal, see {@link org.airwirej.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
