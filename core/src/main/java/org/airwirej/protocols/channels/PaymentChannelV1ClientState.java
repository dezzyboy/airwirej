...
import org.airwirej.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelV1ClientState extends PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelV1ClientState#editContractSendRequest(org.airwirej.core.Wallet.SendRequest)}.
