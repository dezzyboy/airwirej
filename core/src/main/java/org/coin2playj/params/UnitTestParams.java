...
/**
 * Network parameters used by the coin2playj unit tests (and potentially your own). This lets you solve a block using
 * {@link org.coin2playj.core.Block#solve()} by setting difficulty to the easiest possible.
 */
