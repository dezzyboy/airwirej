...
/**
 * <p>A KeyChainGroup is used by the {@link org.coin2playj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.coin2playj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.coin2playj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.coin2playj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
