...
import org.coin2playj.wallet.KeyChain.KeyPurpose;
import org.coin2playj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.coin2playj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.coin2playj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
