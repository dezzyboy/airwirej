...
import org.coin2playj.core.Message;
...
import org.coin2playj.signers.*;
import org.coin2playj.utils.*;
import org.coin2playj.wallet.Protos.Wallet.*;
...
import org.coin2playj.wallet.listeners.WalletEventListener;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.coin2playj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.coin2playj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.coin2playj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.coin2playj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.coin2playj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.coin2playj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.coin2playj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.coin2playj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.coin2playj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.coin2playj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.coin2playj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.coin2playj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.coin2playj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.coin2playj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of coin2playj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.coin2playj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.coin2playj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.coin2playj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.coin2playj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.coin2playj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.coin2playj.crypto.KeyCrypter,
     ...
     * {@link org.coin2playj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.coin2playj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.coin2playj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.coin2playj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.coin2playj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.coin2playj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
