...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link org.coin2playj.crypto.MnemonicCode} for more
     ...
     *
     * @throws org.coin2playj.crypto.MnemonicException if check fails
     */
