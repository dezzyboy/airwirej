...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link org.coin2playj.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the coin2playj protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.coin2playj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
