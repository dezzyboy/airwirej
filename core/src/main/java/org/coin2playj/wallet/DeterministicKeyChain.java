 ...
 * {@link org.coin2playj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.coin2playj.crypto.MnemonicCode},
 ...
 * {@link org.coin2playj.crypto.DeterministicKey#serializePubB58(org.coin2playj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.coin2playj.crypto.DeterministicKey#deserializeB58(org.coin2playj.crypto.DeterministicKey, String, org.coin2playj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.coin2playj.crypto.DeterministicKey,KeyChainType keyChaintype)}.</p>
 *
 * <p>This class builds on {@link org.coin2playj.crypto.DeterministicHierarchy} and
 * {@link org.coin2playj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from coin2playj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.coin2playj.crypto.DeterministicKey)}
     ...
     * @see org.coin2playj.wallet.MarriedKeyChain
     */
