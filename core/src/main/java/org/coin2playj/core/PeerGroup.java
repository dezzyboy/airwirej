...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of coin2playj fixes the known
     ...
     * {@link org.coin2playj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.coin2playj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.coin2playj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.coin2playj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.coin2playj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.coin2playj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.coin2playj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.coin2playj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.coin2playj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a coin2playj based app running in SPV mode to fully validating security.
     */
