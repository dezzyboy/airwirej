 ...
 * the lightweight SPV mode, a {@link org.coin2playj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.coin2playj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
