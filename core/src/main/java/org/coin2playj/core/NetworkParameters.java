...
import org.coin2playj.net.discovery.HttpDiscovery;
...
import org.coin2playj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.coin2playj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.coin2playj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.coin2playj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.coin2playj.core.AlertMessage}s. You can use {@link org.coin2playj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
