 ...
 * {@link org.coin2playj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with coin2playj */
    ...
    /** Returns a checkpoints stream pointing to inside the coin2playj JAR */
