...
public class Transaction extends ChildMessage {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.coin2playj.script.Script, ECKey, org.coin2playj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.coin2playj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.coin2playj.core.TxConfidenceTable}
